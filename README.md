...
This plugin is intended to be loaded via Ayrias Bootstrap module (https://github.com/AyriaPublic/NativeBootstrap) and should be loaded from the users ./Plugins/ directory. 
